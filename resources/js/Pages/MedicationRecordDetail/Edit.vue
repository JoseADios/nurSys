    ...
    <AppLayout title="Editar Detalles de Ficha Medicamentos">
            ...
            <h2 class="font-semibold text-xl text-gray-900 dark:text-white leading-tight">
                <BreadCrumb :items="[
...

                    {
                        ...
                        route:  route('medicationRecords.show', { medicationRecord: medicationRecordDetail.medication_record_id, admission_id:admission_id })
                    },
                    {
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-4 lg:mx-10">
            <form @submit.prevent="submit" class="max-w-xl mx-auto">
                ...
                <label for="fc" class="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">Frecuencia
                ...
                <label for="interval_in_hours"
                    class="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">Intervalo en Horas <span
