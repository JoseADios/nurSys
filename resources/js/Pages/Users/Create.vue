    ...
    <AppLayout>
        ...
        <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6">
            <form @submit.prevent="submit"
                ...
                <!-- Form Actions -->
                <div
                    class="px-6 gap-2 py-4 bg-gray-50 dark:bg-gray-700 flex flex-col sm:flex-row justify-center items-center sm:justify-end space-y-2 sm:space-y-0 rounded-b-lg">
                    <PersonalizableButton @click="saveAndNew" type="button" :loading="form.processing" color="green"
                        shade="600"> Guardar y Crear
                        Otro
                    </PersonalizableButton>
                    <div class="flex justify-evenly space-x-2">
                        <SecondaryLink :href="route('users.index')" as="button"> Cancelar
                        </SecondaryLink>
