...
<AppLayout>
    ...
    <div class="ml-10 mt-4 lg:mx-10">
        <Link :href="route('medicationRecords.index')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
        Volver
        </Link>
    </div>
    ...
    <div class="mb-4 flex flex-col items-center">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <form @submit.prevent="submit" class="max-w-sm mx-auto">
                ...
                <input required id="referrals" type="text" v-model="form.referrals" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe las referencias..." />

                <!-- Estudios Pendientes -->
                <label for="pending_studies" class="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">
                    Estudios Pendientes
                </label>
                <textarea id="pending_studies" rows="4" v-model="form.pending_studies" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe los estudios pendientes..."></textarea>

                <!-- Firma del Doctor -->
                <label for="doctor_sign" class="block mb-2 mt-6 text-sm font-medium text-gray-900 dark:text-white">
                    Firma del Doctor
                </label>
                <input required id="doctor_sign" type="text" v-model="form.doctor_sign" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Firma del doctor..." />
