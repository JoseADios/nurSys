...
<body>
    ...
    <div class="chart">
        <div class="bar" style="height: 40%;" data-value="12"></div>
        <div class="bar" style="height: 70%;" data-value="19"></div>
        <div class="bar" style="height: 15%;" data-value="3"></div>
        <div class="bar" style="height: 25%;" data-value="5"></div>
        <div class="bar" style="height: 10%;" data-value="2"></div>
        <div class="bar" style="height: 15%;" data-value="3"></div>
    </div>
