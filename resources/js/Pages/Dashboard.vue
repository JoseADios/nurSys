            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div
                            class="w-full max-h-[414px] bg-white dark:bg-gray-800 overflow-hidden rounded-lg border border-gray-200/30 dark:border-gray-700/30">
                            <!-- Encabezado fijo -->
                            <div
                                class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10">
                        ...
                        <div
                                ...
                                <div v-for="medication in stats.upcoming_medications"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-4">
                                            <div class="flex-shrink-0">
                                                <div
                                                    class="h-12 w-12 rounded-full bg-indigo-500 flex items-center justify-center text-white font-medium shadow-sm">
                            ...
                            <div v-if="stats.upcoming_medications.length === 0 || !Array.isArray(stats.upcoming_medications)" class="py-12 px-6 text-center">
                                <div
                                    class="rounded-full bg-green-100 dark:bg-green-900/30 mx-auto h-16 w-16 flex items-center justify-center mb-4">
                                    <CheckIcon class="h-8 w-8 text-green-600 dark:text-green-400" />
                                </div>
