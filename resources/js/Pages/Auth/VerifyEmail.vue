...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            Antes de continuar, ¿podrías verificar tu dirección de correo electrónico haciendo clic en el enlace que te acabamos de enviar por correo? Si no recibiste el correo, con gusto te enviaremos otro.
        </div>
