                        ...
                        <div class="relative overflow-hidden rounded-lg   bg-white dark:bg-gray-800 mb-5">
                            ...
                            <div class="max-h-80 overflow-y-auto  shadow-md sm:rounded-lg mt-10 space-y-2 lg:mx-10">
                                ...
                                <div v-for="orders in order" :key="orders.id" class="border rounded-lg">
                                    ...
                                    <div v-for="orderdetail in orders.medical_order_detail" :key="orderdetail.id"
                                        :value="orderdetail.description" @click="selectOrder(orderdetail.id)" :class="{
                                        ...
                                        <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                            ...
                                            <span v-if="selectedOrderId === orderdetail.id"
                ...
                <section class=" p-8 space-y-4  bg-dark-50 dark:bg-dark-700">
                    ...
                    <div v-show="!isVisibleEditSign" class="my-4 flex items-center flex-col justify-center">
                        <div>
                            ...
                            <img v-if="medicationRecord.doctor_sign" class="w-full max-w-md"
                                :src="`/storage/${medicationRecord.doctor_sign}`" alt="Firma">
                            <div v-else>
